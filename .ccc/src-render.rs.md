...
# funcs
    ...
    - L140:8@strip_timestamps:String // replace embedded generation timestamps with a fixed token so freshness
    - L144:4@strip_ts_line:String
    - L162:8@timestamps_are_normalized_away
# refs
# note
