# tokenize.rs.md (20260820-07-57-23) UTC
# source: src/tokenize.rs [rust]
# modules
# imports
    - L9@anyhow (anyhow, ensure, Context, Result)
    - L10@serde (Deserialize, Serialize)
    - L11@std (fs)
    - L12@std::path (Path, PathBuf)
    - L13@tiktoken_rs (CoreBPE)
    - L269@super
# const
    - L15@TOKENS_BIN:&str
